...
def get_arguments():
    ...
    parser.add_argument("--acoustic_impedance_path", help="input acoustic impedance path", default=None)
...
if __name__ == "__main__":
    ...
    if options.acoustic_impedance_path:
        options.facie_num_channels = 2
